...
public class Taille extends Application implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            ...
            String s1 = "Select COUNT(*) AS count FROM Dema WHERE Taille LIKE 'Petite%' ";
            ResultSet rst1 = stm.executeQuery(s1);
            rst1.next();
            int nb = rst1.getInt("count");


            String s2 = "Select COUNT(*) AS count2 FROM Dema WHERE Taille LIKE 'Moyenne%' ";
            ResultSet rst2 = stm.executeQuery(s2);
            rst2.next();
            int nb2 = rst2.getInt("count2");


            String s3 = "Select COUNT(*) AS count3 FROM Dema WHERE Taille LIKE 'Grande%'";
