...
public class FormeEE extends Application implements Initializable {
    @FXML
    ...
    public void Trier() {
        ...
        try {
            ...
            String s1 = "Select COUNT(*) AS count FROM EE WHERE Forme = 'PP%' ";
            ResultSet rst1 = stm.executeQuery(s1);
            rst1.next();
            int nb = rst1.getInt("count");
            ;

            String s2 = "Select COUNT(*) AS count2 FROM EE WHERE LOWER(Forme) = 'sarl' ";
            ResultSet rst2 = stm.executeQuery(s2);
            rst2.next();
            int nb2 = rst2.getInt("count2");


            String s3 = "Select COUNT(*) AS count3 FROM EE WHERE LOWER(Forme) = 'sa'";
            ResultSet rst3 = stm.executeQuery(s3);
            rst3.next();
            int nb3 = rst3.getInt("count3");


            String s4 = "Select COUNT(*) AS count4 FROM EE WHERE  Forme = 'Auto%' ";
            ResultSet rst4 = stm.executeQuery(s4);
            rst4.next();
            int nb4 = rst4.getInt("count4");

            String s5 = "Select COUNT(*) AS count5 FROM EE WHERE Forme = 'Autre' ";
    ...
    public void deleteAction(ActionEvent actionEvent) {
        ...
        tab.setItems(ob);
        try {
            inputStream = new FileInputStream("C:\\Users\\hp\\Desktop\\EE.xlsx");
        } catch (FileNotFoundException e) {
            e.printStackTrace();
        }
        ZipSecureFile.setMinInflateRatio(0);
