...
public class ObjetGuichet extends Application implements Initializable {
    @FXML
    ...
    public Label nProgram;
    public Label nDemarche;
    public Label nAnnuaire;
    public Label nRepertoire;
    public Label pProgram;
    public Label pDemarche;
    public Label pAnnuaire;
    public Label pRepertoire;
    ...
    public void Trier() {
        ...
        try {
            ...
            String s1 = "Select COUNT(*) AS count FROM Guichet WHERE Objet = 'Demande d’aide au montage du dossier / Maroc PME'";
            ResultSet rst1 = stm.executeQuery(s1);
            rst1.next();
            int nb = rst1.getInt("count");


            String s2 = "Select COUNT(*) AS count2 FROM Guichet WHERE Objet = 'Demande d’aide au montage du dossier / Autre organisme'";
            ...
            data.addAll(
                    new PieChart.Data("Demande d’aide au montage du dossier / Maroc PME", p1),
                    new PieChart.Data("Demande d’aide au montage du dossier / Autre organisme", p2));
