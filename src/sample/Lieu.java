...
public class Lieu extends Application implements Initializable{
    @FXML
    ...
    public Label nSaf;
    public Label nKsg;
    public TextArea AreaComm;
    public Button addComm;
    public Button editComm;
    ...
    public void Trier(){
        ...
        try {
            ...
            String s1 = "Select COUNT(*) AS count FROM Dema WHERE LOWER(Lieu)= 'essaouira' ";
            ResultSet rst1 = stm.executeQuery(s1);
            rst1.next();
            int nb = rst1.getInt("count");


            String s2 = "Select COUNT(*) AS count2 FROM Dema WHERE LOWER(Lieu)= 'marrakech' ";
            ResultSet rst2 = stm.executeQuery(s2);
            rst2.next();
            int nb2 = rst2.getInt("count2");


            String s3 = "Select COUNT(*) AS count3 FROM Dema WHERE LOWER(Lieu)= 'safi' ";
            ResultSet rst3 = stm.executeQuery(s3);
            rst3.next();
            int nb3 = rst3.getInt("count3");


            String s4 = "Select COUNT(*) AS count4 FROM Dema WHERE Lieu LIKE 'EL KELAA%' ";
            ...
            percentLabel.setStyle("-fx-font: 20 arial;");
