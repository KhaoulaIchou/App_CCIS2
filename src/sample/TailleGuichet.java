...
public class TailleGuichet extends Application implements Initializable {
    @FXML
    ...
    public void Trier() {
        ...
        try {
            ...
            String s1 = "Select COUNT(*) AS count FROM Guichet WHERE Taille LIKE 'Petite%' ";
            ResultSet rst1 = stm.executeQuery(s1);
            rst1.next();
            int nb = rst1.getInt("count");
            ;

            String s2 = "Select COUNT(*) AS count2 FROM Guichet WHERE Taille LIKE 'Moyenne%' ";
            ResultSet rst2 = stm.executeQuery(s2);
            rst2.next();
            int nb2 = rst2.getInt("count2");


            String s3 = "Select COUNT(*) AS count3 FROM Guichet WHERE Taille LIKE 'Grande%'";
            ...
            data.addAll(
                    new PieChart.Data("Petite (< 10 P)", p1),
                    new PieChart.Data("Moyenne (10 – 200P)", p2),
                    new PieChart.Data("Grande (> 200P)", p3)
