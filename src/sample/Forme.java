...
public class Forme extends Application implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            ...
            String s1 = "Select COUNT(*) AS count FROM Dema WHERE Forme = 'PP%' ";
            ResultSet rst1 = stm.executeQuery(s1);
            rst1.next();
            int nb = rst1.getInt("count");
            ;

            String s2 = "Select COUNT(*) AS count2 FROM Dema WHERE LOWER(Forme) = 'sarl' ";
            ResultSet rst2 = stm.executeQuery(s2);
            rst2.next();
            int nb2 = rst2.getInt("count2");


            String s3 = "Select COUNT(*) AS count3 FROM Dema WHERE LOWER(Forme) = 'sa'";
            ResultSet rst3 = stm.executeQuery(s3);
            rst3.next();
            int nb3 = rst3.getInt("count3");


            String s4 = "Select COUNT(*) AS count4 FROM Dema WHERE  Forme = 'Auto%' ";
            ResultSet rst4 = stm.executeQuery(s4);
            rst4.next();
            int nb4 = rst4.getInt("count4");

            String s5 = "Select COUNT(*) AS count5 FROM Dema WHERE Forme = 'Autre' ";
    ...
    public void deleteAction(ActionEvent actionEvent) {
       ...
       if(response==JOptionPane.NO_OPTION){
           tab.getItems().removeAll(tab.getItems().get(0).g);
        }else{
