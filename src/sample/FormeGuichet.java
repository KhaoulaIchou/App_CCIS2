...
public class FormeGuichet extends Application implements Initializable {
    @FXML
    ...
    public Label nSA;
    public Label nAuto;
    public Label nAutreForme;
    public Label pPP;
    public Label pSARL;
    public Label pSA;
    public Label pAuto;
    public Label pAutreForme;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            ...
            inputStream = new FileInputStream("C:\\Users\\hp\\IdeaProjects\\App_CCIS2\\src\\sample\\DocImg\\Guichet.xlsx");
    ...
    public void Trier() {
        ...
        try {
            ...
            String query = "TRUNCATE TABLE Guichet";
            stm = con.prepareStatement(query);
            rst = stm.executeQuery(query);
            String query1 = "INSERT INTO Guichet(ICE,NomPre,Lieu,Objet,Statut,Tele,Email,Adresse,Ville,Deno,RepLegal,Site,Forme,Taille,Secteur,Activite) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            ...
            String s1 = "Select COUNT(*) AS count FROM Guichet WHERE Forme = 'PP%' ";
            ResultSet rst1 = stm.executeQuery(s1);
            rst1.next();
            int nb = rst1.getInt("count");
            ;

            String s2 = "Select COUNT(*) AS count2 FROM Guichet WHERE LOWER(Forme) = 'sarl' ";
            ResultSet rst2 = stm.executeQuery(s2);
            rst2.next();
            int nb2 = rst2.getInt("count2");


            String s3 = "Select COUNT(*) AS count3 FROM Guichet WHERE LOWER(Forme) = 'sa'";
            ResultSet rst3 = stm.executeQuery(s3);
            rst3.next();
            int nb3 = rst3.getInt("count3");


            String s4 = "Select COUNT(*) AS count4 FROM Guichet WHERE  Forme = 'Auto%' ";
            ResultSet rst4 = stm.executeQuery(s4);
            rst4.next();
            int nb4 = rst4.getInt("count4");

            String s5 = "Select COUNT(*) AS count5 FROM Guichet WHERE Forme = 'Autre' ";
            ...
            data.addAll(
                    new PieChart.Data("PP (Personne physique)", p1),
                    new PieChart.Data("SARL", p2),
                    new PieChart.Data("SA", p3),
                    new PieChart.Data("Auto-entrepreneur", p4),
                    new PieChart.Data("Autre", p5)
            );
