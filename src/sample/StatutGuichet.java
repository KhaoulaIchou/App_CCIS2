...
public class StatutGuichet extends Application implements Initializable {
    @FXML
    ...
    public void Trier() {
        ...
        try {
            ...
            String s1 = "Select COUNT(*) AS count FROM Guichet WHERE Statut = 'Entrepreneur' ";
            ResultSet rst1 = stm.executeQuery(s1);
            rst1.next();
            int nb = rst1.getInt("count");


            String s2 = "Select COUNT(*) AS count2 FROM Guichet WHERE LOWER(Statut)= 'porteur de projet' ";
