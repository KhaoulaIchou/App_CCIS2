...
public class ObjetEE extends Application implements Initializable {
    @FXML
    ...
    public void Trier() {
        ...
        try {
            ...
            String s1 = "Select COUNT(*) AS count FROM EE WHERE Objet LIKE 'Programme%' ";
            ResultSet rst1 = stm.executeQuery(s1);
            rst1.next();
            int nb = rst1.getInt("count");


            String s2 = "Select COUNT(*) AS count2 FROM EE WHERE Objet LIKE 'Démarches%' ";
            ResultSet rst2 = stm.executeQuery(s2);
            rst2.next();
            int nb2 = rst2.getInt("count2");


            String s3 = "Select COUNT(*) AS count3 FROM EE WHERE Objet LIKE 'Annuaire%' ";
            ResultSet rst3 = stm.executeQuery(s3);
            rst3.next();
            int nb3 = rst3.getInt("count3");


            String s4 = "Select COUNT(*) AS count4 FROM EE WHERE Objet LIKE 'Répertoire%' ";
            ...
            data.addAll(
                    new PieChart.Data("Programmes d’appui / aide aux entreprises", p1),
                    new PieChart.Data("Démarches administratives", p2),
                    new PieChart.Data("Annuaire des entreprises", p3),
                    new PieChart.Data("Répertoire de contact des administrations", p3));
